...
//This doesn't work because of the scope of the arrow function.
...
//  THIS WORKS BECAUSE IT'S NOT A PROTOTYPE
...
//    'this' refers to the instance Joe of the Student Constructor
// 2. What is "this" when joe.scopeArrow() is invoked?
//    'this' definition doesn't exist within the scope arrow so we moved one level up to check the scope of the whole window.
// 3. Explain why "this" is different when an arrow function is used.
//    In arrow functions, this is not bound to the object, but instead it's bound to the global scope.
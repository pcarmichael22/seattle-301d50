...
function displayPics() {
    ...
    // This code broke because when we changed the rando variable to let, it was only accesible within the function, and could not be accessed by the console log on line 38.
    console.log(viewed);
